...
declare const useCheckPermissionsQuery: import("@reduxjs/toolkit/dist/query/react/buildHooks").UseQuery<import("@reduxjs/toolkit/query").QueryDefinition<{
...
}, import("@reduxjs/toolkit/query").BaseQueryFn<string | import("@strapi/admin/strapi-admin").QueryArguments, unknown, import("@strapi/admin/strapi-admin").BaseQueryError>, "User" | "Me" | "ProvidersOptions", Check.Response, "adminApi">>, useLazyCheckPermissionsQuery: import("@reduxjs/toolkit/dist/query/react/buildHooks").UseLazyQuery<import("@reduxjs/toolkit/query").QueryDefinition<{
    permissions: (Pick<import("../../../shared/contracts/shared").Permission, "action" | "subject"> & {
        field?: string | undefined;
    })[];
}, import("@reduxjs/toolkit/query").BaseQueryFn<string | import("@strapi/admin/strapi-admin").QueryArguments, unknown, import("@strapi/admin/strapi-admin").BaseQueryError>, "User" | "Me" | "ProvidersOptions", Check.Response, "adminApi">>, useGetMeQuery: import("@reduxjs/toolkit/dist/query/react/buildHooks").UseQuery<import("@reduxjs/toolkit/query").QueryDefinition<void, import("@reduxjs/toolkit/query").BaseQueryFn<string | import("@strapi/admin/strapi-admin").QueryArguments, unknown, import("@strapi/admin/strapi-admin").BaseQueryError>, "User" | "Me" | "ProvidersOptions", import("@strapi/admin/strapi-admin").SanitizedAdminUser, "adminApi">>, useLoginMutation: import("@reduxjs/toolkit/dist/query/react/buildHooks").UseMutation<import("@reduxjs/toolkit/query").MutationDefinition<Pick<import("@strapi/admin/strapi-admin").AdminUser, "email" | "password">, import("@reduxjs/toolkit/query").BaseQueryFn<string | import("@strapi/admin/strapi-admin").QueryArguments, unknown, import("@strapi/admin/strapi-admin").BaseQueryError>, "User" | "Me" | "ProvidersOptions", {
    token: string;
    user: Omit<import("@strapi/admin/strapi-admin").SanitizedAdminUser, "permissions">;
    ...
    userInfo: Pick<import("@strapi/admin/strapi-admin").AdminUser, "firstname" | "lastname" | "email" | "password">;
}, import("@reduxjs/toolkit/query").BaseQueryFn<string | import("@strapi/admin/strapi-admin").QueryArguments, unknown, import("@strapi/admin/strapi-admin").BaseQueryError>, "User" | "Me" | "ProvidersOptions", {
    token: string;
    user: Omit<import("@strapi/admin/strapi-admin").SanitizedAdminUser, "permissions">;
