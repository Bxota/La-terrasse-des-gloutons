...
import { type SimpleMenuProps } from '@strapi/design-system/src/components/SimpleMenu';
export type CrumbSimpleMenuProps = SimpleMenuProps & {
    'aria-label': string;
    icon?: React.ReactElement;
    endIcon?: React.ReactNode;
};
export declare const CrumbSimpleMenu: React.ForwardRefExoticComponent<(Omit<Omit<import("@strapi/design-system/src/components").ButtonProps, "tag"> & {
    endIcon?: React.ReactNode;
...
} & Pick<import("@strapi/design-system/src/components/SimpleMenu/Menu").ContentProps, "intersectionId" | "popoverPlacement"> & {
