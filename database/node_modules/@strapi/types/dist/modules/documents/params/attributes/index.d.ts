...
import type { Array, Constants, Object, If, Extends, MatchFirst, IsNotNever } from '@strapi/types/src/utils';
import type { ID, DocumentID } from '@strapi/types/src/modules/documents/params/attributes/id';
import type { OmitRelationsWithoutTarget, RelationInputValue } from '@strapi/types/src/modules/documents/params/attributes/relations';
 ...
 */
export type GetValue<TAttribute extends Schema.Attribute.Attribute> = If<IsNotNever<TAttribute>, MatchFirst<[
    [
        Extends<TAttribute, Schema.Attribute.OfType<'relation'>>,
        TAttribute extends Schema.Attribute.RelationWithTarget ? RelationInputValue<TAttribute['relation']> : never
    ],
    [
    ...
    [
        Constants.True,
        Schema.Attribute.Value<TAttribute>
    ]
], unknown>, unknown>;
