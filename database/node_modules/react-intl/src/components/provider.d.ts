...
import type { IntlConfig, IntlShape } from 'react-intl/src/types';
interface State {
    /**
...
export default class IntlProvider extends React.PureComponent<React.PropsWithChildren<IntlConfig>, State> {
    ...
    static defaultProps: Pick<import("react-intl/src/types").ResolvedIntlConfig, "timeZone" | "onError" | "fallbackOnEmptyString" | "formats" | "messages" | "defaultLocale" | "defaultFormats" | "textComponent">;
    private cache;
    state: State;
