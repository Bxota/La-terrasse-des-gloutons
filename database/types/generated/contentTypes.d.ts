...
export interface ApiAllergenAllergen extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    plates: Schema.Attribute.Relation<'manyToMany', 'api::plate.plate'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiDrinkDrink extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::drink.drink'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    on_card: Schema.Attribute.Boolean;
...
export interface ApiFormuleFormule extends Struct.CollectionTypeSchema {
...
export interface ApiPlateCategoryPlateCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'plate_categories';
  info: {
    displayName: 'Plate Category';
    pluralName: 'plate-categories';
    singularName: 'plate-category';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::plate-category.plate-category'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    plates: Schema.Attribute.Relation<'oneToMany', 'api::plate.plate'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPlatePlate extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    on_card: Schema.Attribute.Boolean;
    plate_category: Schema.Attribute.Relation<
      'manyToOne',
      'api::plate-category.plate-category'
    >;
    price: Schema.Attribute.Decimal;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::plate-category.plate-category': ApiPlateCategoryPlateCategory;
